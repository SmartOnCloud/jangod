...
public class TreeRebuilder {
	...
	if (node != null && toAdd != null) {
	    try {
		Method action = NodeAction.class.getDeclaredMethod(
			"insertAfter", new Class[] { Node.class, Node.class });
	...
	if (node != null && toAdd != null) {
	    try {
		Method action = NodeAction.class.getDeclaredMethod(
			"insertBefore", new Class[] { Node.class, Node.class });
		Object[] msg = new Object[] { node, toAdd };
		actions.add(action);
		msgs.add(msg);
	    } catch (Exception e) {
	...
	if (parent != null && toAdd != null) {
	    try {
		Method action = NodeAction.class.getDeclaredMethod(
			"addChildLast", new Class[] { Node.class, Node.class });
	...
	if (parent != null && toAdd != null) {
	    try {
		Method action = NodeAction.class
			.getDeclaredMethod("addChildFirst", new Class[] {
