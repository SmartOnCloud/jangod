...
public class Processor {
    ...
    public String render(String templateFile, Map<String, Object> bindings,
	    Locale locale) throws IOException {
	return render(templateFile, bindings, context.getConfiguration()
		.getEncoding(), locale);
    }

    public String render(String templateFile, Map<String, Object> bindings,
	    String encoding, Locale locale) throws IOException {
	if (bindings == null) {
...
//		.getConfiguration().getWorkspace());
	...
	try {
	    ...
	    return interpreter.render(application.getParseResult(fullName,
		    encoding));
	} catch (Exception e) {
    ...
    public void render(String templateFile, Map<String, Object> bindings,
	    Writer out, String encoding, Locale locale) throws IOException {
	out.write(render(templateFile, bindings, encoding, locale));
    }

    public void render(String templateFile, Map<String, Object> bindings,
	    Writer out, Locale locale) throws IOException {
